      ...
      <div className="relative overflow-hidden">
        ...
        <div className="bg-gray-900">
          <div className={`relative isolate overflow-hidden  font-lead `}>
            ...
            <div 
              className="absolute inset-0 bg-gradient-to-b from-sky-200/10 via-transparent to-sky-300/20 pointer-events-none"
              style={{ 
                zIndex: -20,
                backfaceVisibility: 'hidden' // Prevent flickering
              }}
            ...
            >
              <div
                className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#87CEEB] to-[#B0E0E6] opacity-15 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
                style={{
                  clipPath:
